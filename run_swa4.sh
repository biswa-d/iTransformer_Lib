...
FACTOR=1
DEVICES="0,1"
TRAIN_EPOCHS=300 # SWA benefits from longer training
BATCH_SIZE=200
TEST_BATCH_SIZE=200 # Define test batch size
PATIENCE=20 # Early stopping based on pre-SWA validation loss
...
SWA_START_FRAC=0.75 # Start SWA after 75% of epochs
SWA_LR=0.0004 # Specify SWA learning rate (can be None to use LEARNING_RATE)
SWA_ANNEAL_EPOCHS=10 # SWA LR annealing period
