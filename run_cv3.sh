...
FACTOR=1
DEVICES="0,1"
TRAIN_EPOCHS_PER_FOLD=200 # <<< Set back to 1 for quick test
BATCH_SIZE=200
TEST_BATCH_SIZE=200
NUM_WORKERS=10
PATIENCE=200
...
EXPLOIT_LR=0.00005     # Starting LR for exploitation cycles (defaults to min_lr if None/empty)
