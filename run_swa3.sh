...
E_LAYERS=2
D_LAYERS=1
D_FF=64 # Using the smaller D_FF from cosine script
MOVING_AVG=25
FACTOR=1
DEVICES="0,1"
TRAIN_EPOCHS=800 # SWA benefits from longer training
BATCH_SIZE=200
...
SWA_LR=0.0001 # Specify SWA learning rate (can be None to use LEARNING_RATE)
SWA_ANNEAL_EPOCHS=40 # SWA LR annealing period
