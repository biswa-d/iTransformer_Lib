...
if __name__ == '__main__':
    ...
    # New argument for the timestamp generated by the shell script
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            # Save the exact setting name for the default test run
            try:
                with open('last_setting.txt', 'w') as f:
                    f.write(setting)
            except IOError as e:
                print(f"Warning: Could not write last_setting.txt: {e}")
