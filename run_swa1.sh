...
E_LAYERS=2
D_LAYERS=1
D_FF=16 # Using the smaller D_FF from cosine script
MOVING_AVG=25
FACTOR=1
DEVICES="0,1"
TRAIN_EPOCHS=500 # SWA benefits from longer training
BATCH_SIZE=200
TEST_BATCH_SIZE=200 # Define test batch size
PATIENCE=500 # Early stopping based on pre-SWA validation loss
