...
from xlstm.components.ln import MultiHeadLayerNorm
from xlstm.blocks.mlstm.backends_m import parallel_stabilized_simple, recurrent_step_stabilized_simple
...
class mLSTMCell(nn.Module):
    ...
    def __init__(self, config: mLSTMCellConfig):
        ...
        # Updated backends from backends_m.py
        ...
        # Causal mask for sequence processing
    ...
    def forward(self, q: torch.Tensor, k: torch.Tensor, v: torch.Tensor, **kwargs) -> torch.Tensor:
        ...
        # Compute hidden state with backend
    ...
    def step(
        ...
        **kwargs,
        ...
        # Run recurrent step with backend
        ...
        h_state_norm = h_state_norm.transpose(1, 2).reshape(B, S, -1)  # (B, NH, S, DH) -> (B, S, H)
